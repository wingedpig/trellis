...
<div class="list-group mb-4">
    `)
//line views/worktrees.qtpl:24
	for _, wt := range p.Worktrees {
//line views/worktrees.qtpl:24
		qw422016.N().S(`
    `)
//line views/worktrees.qtpl:25
...
//line views/worktrees.qtpl:116
		qw422016.E().S(p.BinariesDir)
//line views/worktrees.qtpl:116
		qw422016.N().S(`</code></p>
</div>
`)
//line views/worktrees.qtpl:118
	}
//line views/worktrees.qtpl:118
	qw422016.N().S(`
...
function createWorktree(branchName, switchTo) {
    ...
    .then(function(data) {
        if (data.error) {
            showAlert('Error: ' + data.error.message, 'Error');
        } else {
            location.reload();
        }
    })
...
document.getElementById('confirmRemoveBtn').onclick = function() {
    ...
    var url = '/api/v1/worktrees/' + encodeURIComponent(currentRemoveWorktree);
    if (deleteBranch) {
        url += '?delete_branch=1';
    }
...
`)
//line views/worktrees.qtpl:460
	p.StreamFooter(qw422016)
//line views/worktrees.qtpl:460
	qw422016.N().S(`
`)
//line views/worktrees.qtpl:461
}
