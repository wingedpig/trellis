    ...
    function openHistoryPicker() {
        ...
        for (const key of navHistory) {
            ...
            if (optionMap[key]) {
                ...
                if (key.startsWith('/trace/report/')) {
        ...
        ws.onmessage = (event) => {
            try {
                ...
                if (msg.type) {
                    ...
                    // Refresh nav picker for worktree/service events
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="d-flex align-items-center gap-3 ms-auto">
                `)
//line views/header.qtpl:731
	if p.Worktree != nil {
//line views/header.qtpl:731
		qw422016.N().S(`
                <span class="navbar-text">
                    <i class="fa-solid fa-code-branch text-accent"></i> `)
//line views/header.qtpl:733
